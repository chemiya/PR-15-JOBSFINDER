...
&& isset($data->idOferta) 
 ...
 && !empty(trim($data->idOferta))
		...
		$allOfertas = mysqli_query($db_conn,"SELECT g.idUsuario,g.idOferta FROM guardada g  where g.idUsuario='$idUsuario' and g.idOferta='$idOferta'");//hace consulta para buscar uno
