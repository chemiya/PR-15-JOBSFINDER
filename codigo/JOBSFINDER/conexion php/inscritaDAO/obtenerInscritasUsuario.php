...
if(isset($data->idUsuario) 
	&& !empty(trim($data->idUsuario))
		...
		$allOfertas = mysqli_query($db_conn,"SELECT o.idOferta as idOferta, o.descripcion as descripcion, o.estado as estado, u.username as username,u.fotoRuta as fotoRuta, i.mensaje as mensaje FROM inscripcion i, oferta o, usuario u  where i.idUsuario='$idUsuario' and i.idOferta=o.idOferta and o.idUsuario=u.idUsuario");//hace consulta para buscar uno
