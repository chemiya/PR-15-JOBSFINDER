...
require './../db_connection.php';//llamamos la conexion
	$allOfertas= mysqli_query($db_conn,"SELECT o.idOferta as idOferta,o.descripcion as descripcion, o.estado as estado, u.username as username  FROM oferta o, usuario u where o.idUsuario=u.idUsuario");//busca todos
