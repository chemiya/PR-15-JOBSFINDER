...
if(isset($data->idOferta) 
	&& !empty(trim($data->idOferta))
		...
		$allOfertas = mysqli_query($db_conn,"SELECT o.idOferta as idOferta, o.descripcion as descripcion,o.idUsuario as idUsuario, o.estado as estado, o.detallesSueldo as detallesSueldo, o.detallesFormato as detallesFormato,o.detallesExperiencia as detallesExperiencia, u.username as username FROM oferta o, usuario u where o.idOferta='$idOferta' and u.idUsuario=o.idUsuario ");//hace consulta para buscar uno
